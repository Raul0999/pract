...
def level_one():
    print_delay("Уровень 1: Вы стоите перед входом в древний замок. Перед вами три двери:")
...
def level_two():
    print_delay("Уровень 2: Ваша книга заклинаний содержит загадку. Вам нужно решить её:")
...
def level_four():
    print_delay("Уровень 4: Внутри вы находите древний алтарь. Вам нужно найти подсказку о местонахождении магической чаши.")
...
def level_five():
    print_delay("Уровень 5: Вы нашли магическую чашу!")
    end_game(True)


def end_game(success):
    if success:
        print_delay("Поздравляю! Вы нашли магическую чашу и стали легендарным исследователем!")
    else:
        print_delay("К сожалению, вы не смогли найти магическую чашу. Попробуйте снова.")
    play_again()
